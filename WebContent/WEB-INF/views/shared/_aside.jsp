	...
	<%if(session.getAttribute("grupoTutorizaProfesor") != null){ %>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="consultarTutoria">Mis tutorías</a>
                </div>
            </div>
        </li>
		<% } %>
		<% String codigoProfesor = (String)session.getAttribute("codigoProfesor");%>
		<% if( codigoProfesor.equals("ADMIN")){ %>
			 <!-- Divider -->
        <hr class="sidebar-divider">
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Profesorado</h6>
                    <a class="collapse-item" href="consultarProfesorado">Consultar profesorado</a>
                    <div class="collapse-divider"></div>
                    <h6 class="collapse-header">Alumnado</h6>
                    <a class="collapse-item" href="consultarAlumnadoAdmin">Consultar alumnado</a>
                    <a class="collapse-item" href="anadirAlumno">Añadir alumno</a>
                    <a class="collapse-item" href="subirCurso">Subir curso</a>
                    <a class="collapse-item" href="eliminarCurso">Eliminar Curso</a>
                </div>
            </div>
        </li>
		<%} %>
